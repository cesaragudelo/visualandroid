...
if (isset($_REQUEST['usr']) && isset($_REQUEST['clave']) && isset($_REQUEST['nombre']) && isset($_REQUEST['correo']))
{
	...
	$result = mysqli_query($cnx,"select correo from equipos where correo = '$correo'");
	if (mysqli_num_rows($result)==0)
	{
		mysqli_query($cnx,"INSERT INTO equipos (usr,nombre,correo,clave) VALUES ('$usr','$nombre','$correo','$clave')");	
	}
	else
	{
